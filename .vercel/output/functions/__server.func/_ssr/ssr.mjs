...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DdsZIjuT.mjs");
...
var manifest = { "b79c3e16a3945c23dd7aa59972587fbb49a208d6d62dab965fa76a94a780892c": {
	functionName: "loadOhlcv_createServerFn_handler",
	importer: () => import("./load-ohlcv-BKJv__vo.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CKZwNOb4.mjs").then((n) => n.t),
