...
function Cr(t, i) {
	return ei(Math.max(i, 12) * ("circle" === t ? .8 : "square" === t ? .7 : 1));
}
function yr(t) {
	return function(t) {
		const i = Math.ceil(t);
...
function Pr(t) {
	return Math.max(xr(t, .1), 3);
}
function kr(t, i, n) {
	return i ? t : n ? Math.ceil(t / 2) : 0;
}
function Tr(t, i, n, s) {
	const e = (Cr("arrowUp", s) - 1) / 2 * n.YS, r = (ei(s / 2) - 1) / 2 * n.YS;
	i.beginPath(), t ? (i.moveTo(n._t - e, n.ut), i.lineTo(n._t, n.ut - e), i.lineTo(n._t + e, n.ut), i.lineTo(n._t + r, n.ut), i.lineTo(n._t + r, n.ut + e), i.lineTo(n._t - r, n.ut + e), i.lineTo(n._t - r, n.ut)) : (i.moveTo(n._t - e, n.ut), i.lineTo(n._t, n.ut + e), i.lineTo(n._t + e, n.ut), i.lineTo(n._t + r, n.ut), i.lineTo(n._t + r, n.ut - e), i.lineTo(n._t - r, n.ut - e), i.lineTo(n._t - r, n.ut)), i.fill();
}
function Rr(t, i, n, s, e, r) {
	const h = (Cr("arrowUp", s) - 1) / 2, a = (ei(s / 2) - 1) / 2;
	if (e >= i - a - 2 && e <= i + a + 2 && r >= (t ? n : n - h) - 2 && r <= (t ? n + h : n) + 2) return !0;
	return (() => {
		if (e < i - h - 3 || e > i + h + 3 || r < (t ? n - h - 3 : n) || r > (t ? n : n + h + 3)) return !1;
		const s = Math.abs(e - i);
		return Math.abs(r - n) + 3 >= s / 2;
	})();
}
var Dr = class {
	constructor() {
	...
	draw(t) {
		"aboveSeries" !== this.KS && t.useBitmapCoordinateSpace(((t) => {
			this.et(t);
		}));
	}
	drawBackground(t) {
	...
	et({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
		if (null !== this.qt && null !== this.qt.lt) {
			...
			for (let s = this.qt.lt.from; s < this.qt.lt.to; s++) {
				...
				void 0 !== e.ri && (e.ri.nn = this.$s.Ii(t, e.ri.GS), e.ri.$t = this.F, e.ri._t = e._t - e.ri.nn / 2), Ir(e, t, i, n);
			}
		}
	}
};
function Ir(t, i, n, s) {
	i.fillStyle = t.R, void 0 !== t.ri && function(t, i, n, s, e, r) {
		t.save(), t.scale(e, r), t.fillText(i, n, s), t.restore();
	}(i, t.ri.GS, t.ri._t, t.ri.ut, n, s), function(t, i, n) {
		if (0 === t.Th) return;
		switch (t.ZS) {
			case "arrowDown":
				Tr(!1, i, n, t.Th);
			...
			case "circle":
				(function(t, i, n) {
					const s = (Cr("circle", n) - 1) / 2;
					t.beginPath(), t.arc(i._t, i.ut, s * i.YS, 0, 2 * Math.PI, !1), t.fill();
				})(i, n, t.Th);
				return;
			case "square":
				(function(t, i, n) {
					const s = Cr("square", n), e = (s - 1) * i.YS / 2, r = i._t - e, h = i.ut - e;
					t.fillRect(r, h, s * i.YS, s * i.YS);
				})(i, n, t.Th);
				return;
		}
		t.ZS;
...
function Vr(t, i, n) {
	return !(void 0 === t.ri || !function(t, i, n, s, e, r) {
		const h = s / 2;
		return e >= t && e <= t + n && r >= i - h && r <= i + h;
	}(t.ri._t, t.ri.ut, t.ri.nn, t.ri.$t, i, n)) || function(t, i, n) {
		if (0 === t.Th) return !1;
		switch (t.ZS) {
			case "arrowDown": return Rr(!0, t._t, t.ut, t.Th, i, n);
			case "arrowUp": return Rr(!1, t._t, t.ut, t.Th, i, n);
			case "circle": return function(t, i, n, s, e) {
				const r = 2 + Cr("circle", n) / 2, h = t - s, a = i - e;
				return Math.sqrt(h * h + a * a) <= r;
			}(t._t, t.ut, t.Th, i, n);
			case "square": return function(t, i, n, s, e) {
				const r = Cr("square", n), h = (r - 1) / 2, a = t - h, l = i - h;
				return s >= a && s <= a + r && e >= l && e <= l + r;
			}(t._t, t.ut, t.Th, i, n);
		}
	}(t, i, n);
}
...
function Er(t, i, n, s, e, r, h, a) {
	const l = function(t, i, n) {
		if (Br(i.position) && void 0 !== i.price) return i.price;
		...
		if (function(t) {
			...
			if ("aboveBar" === i.position) return n ? t.low : t.high;
			if ("belowBar" === i.position) return n ? t.high : t.low;
		}
	}(n, i, h.priceScale().options().invertScale);
	if (void 0 === l) return;
	const o = Br(i.position), _ = a.timeScale(), c = p(i.size) ? Math.max(i.size, 0) : 1, d = yr(_.options().barSpacing) * c, f = d / 2;
	t.Th = d;
	switch (i.position) {
		case "inBar":
		case "atPriceMiddle":
			t.ut = u(h.priceToCoordinate(l)), void 0 !== t.ri && (t.ri.ut = t.ut + f + r + .6 * e);
			return;
		case "aboveBar":
		case "atPriceTop": {
			const i = o ? 0 : s.XS;
			t.ut = u(h.priceToCoordinate(l)) - f - i, void 0 !== t.ri && (t.ri.ut = t.ut - f - .6 * e, s.XS += 1.2 * e), o || (s.XS += d + r);
			return;
		}
		case "belowBar":
		case "atPriceBottom": {
			const i = o ? 0 : s.JS;
			t.ut = u(h.priceToCoordinate(l)) + f + i, void 0 !== t.ri && (t.ri.ut = t.ut + f + r + .6 * e, s.JS += 1.2 * e), o || (s.JS += d + r);
			return;
		}
	}
}
var Ar = class {
	constructor(t, i, n) {
		this.QS = [], this.xt = !0, this.tx = !0, this.Xt = new Dr(), this.Te = t, this.Gv = i, this.qt = {
			ot: [],
			lt: null
		}, this.yn = n;
	}
	...
	Ig() {
		...
		if (null === s) return;
		const e = new Ai(Math.floor(s.from), Math.ceil(s.to));
		if (null === this.Te.dataByIndex(0, 1)) return;
		if (0 === this.qt.ot.length) return;
		let r = NaN;
		const h = Pr(t.options().barSpacing), a = {
			XS: h,
			JS: h
		};
		this.qt.lt = Rs(this.qt.ot, e, !0);
		for (let s = this.qt.lt.from; s < this.qt.lt.to; s++) {
			const e = i[s];
			e.time !== r && (a.XS = h, a.JS = h, r = e.time);
			const l = this.qt.ot[s];
			...
			const o = this.Te.dataByIndex(e.time, 0);
			null !== o && Er(l, e, o, a, n.fontSize, h, this.Te, this.Gv);
		}
		this.xt = !1;
	}
};
...
var zr = class {
	constructor(t) {
		this.Yh = null, this.QS = [], this.hx = [], this.lx = null, this.Te = null, this.Gv = null, this.ox = !0, this._x = null, this.ux = null, this.vx = null, this.mx = !0, this.yn = Lr(t);
	}
	attached(t) {
		this.wx(), this.Gv = t.chart, this.Te = t.series, this.Yh = new Ar(this.Te, u(this.Gv), this.yn), this.jS = t.requestUpdate, this.Te.subscribeDataChanged(((t) => this.Qg(t))), this.mx = !0, this.DS();
	}
	DS() {
		this.jS && this.jS();
	}
	...
	ix(t) {
		this.mx = !0, this.QS = t, this.wx(), this.ox = !0, this.ux = null, this.DS();
	}
	Mx() {
		return this.QS;
	}
	...
	bx() {
		...
		if (this.ox || t !== this.vx) {
			if (this.vx = t, this.QS.length > 0) {
				...
				this._x = {
					above: kr(n, s.aboveBar, s.inBar),
					below: kr(n, s.belowBar, s.inBar)
				};
			} else this._x = null;
			this.ox = !1;
		}
	...
	Sx() {
		return null === this.ux && (this.ux = this.QS.reduce(((t, i) => (t[i.position] || (t[i.position] = !0), t)), {
			inBar: !1,
			aboveBar: !1,
			belowBar: !1,
			atPriceTop: !1,
	...
	wx() {
		...
		const n = t.timeToIndex(u(i[0].time), !0);
		this.hx = this.QS.map(((i, s) => {
			const e = t.timeToIndex(i.time, !0), r = e < n ? 1 : -1, h = u(this.Te).dataByIndex(e, r), a = {
